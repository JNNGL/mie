...
int main() {
    ...
    mie::ParticleDistribution particle = {
        ...
        {{.etaHost = {1.0, 0.0}, .eta = {1.333, 0.0}, 2.0e-6}, 1.0},
        {{.etaHost = {1.0, 0.0}, .eta = {1.333, 0.0}, 3.0e-6}, 2.0},
        {{.etaHost = {1.0, 0.0}, .eta = {1.333, 0.0}, 4.0e-6}, 3.0},
        {{.etaHost = {1.0, 0.0}, .eta = {1.333, 0.0}, 5.0e-6}, 4.0},
        {{.etaHost = {1.0, 0.0}, .eta = {1.333, 0.0}, 6.0e-6}, 5.0},
        {{.etaHost = {1.0, 0.0}, .eta = {1.333, 0.0}, 7.0e-6}, 6.0},
        {{.etaHost = {1.0, 0.0}, .eta = {1.333, 0.0}, 8.0e-6}, 7.0},
        {{.etaHost = {1.0, 0.0}, .eta = {1.333, 0.0}, 9.0e-6}, 8.0},
    };

    std::vector<double> x(10000);
    std::vector<double> cosTheta(10000);
